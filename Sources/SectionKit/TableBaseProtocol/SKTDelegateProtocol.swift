...
public protocol SKTDelegateProtocol {
    ...
    func item(willDisplay view: UITableViewCell, row: Int)
    func item(didEndDisplaying view: UITableViewCell, row: Int)
    
    func supplementary(willDisplay view: UIView, kind: SKSupplementaryKind)
    func supplementary(didEndDisplaying view: UIView, kind: SKSupplementaryKind)
    ...
    func item(willSelect row: Int) -> IndexPath?
    func item(willDeselect row: Int) -> IndexPath?
    ...
    func item(titleForDeleteConfirmationButton row: Int) -> String?
    func item(leadingSwipeActionsConfiguration row: Int) -> UISwipeActionsConfiguration?
    func item(trailingSwipeActionsConfiguration row: Int) -> UISwipeActionsConfiguration?
    func item(shouldIndentWhileEditing row: Int) -> Bool
    func item(indentationLevel row: Int) -> Int
    func item(willEditing row: Int)
    func item(edited row: Int)
